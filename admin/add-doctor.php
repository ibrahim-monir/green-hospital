...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <form action="/admin/confirm-add-doctor.php" method="post">
            <!-- card start here  -->
            <div class="card">
                <div class="header">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                                ...
                                <input id="mobile" class="form-control" type="tel" name="mobile_number" value="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                                ...
                                <input id="fname" class="form-control" type="text" name="fullname" value="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                                <label for="dob">Date of Birth </label>
                                <input id="dob" class="form-control" type="date" name="dob" value="">
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group c_form_group">
                                ...
                                <input id="age" class="form-control" type="number" name="age" value="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group c_form_group">
                                ...
                                <input id="designation" class="form-control" type="text" name="designation" value="">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group c_form_group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                                ...
                                <textarea rows="3" id="shortbio" class="form-control no-resize" name="shortbio"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                                <label for="details">details<span class="text-danger">*</span></label>
                                <textarea rows="3" id="details" class="form-control" name="details"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                                <label for="specialist">Specialist<span class="text-danger">*</span></label>
                                <input id="specialist" class="form-control" type="text" name="specialist" >
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group c_form_group">
                                    ...
                                    <?php
                                        ...
                                        if($dp){
                                            while($row = mysqli_fetch_assoc($dp)){
                                                echo '<option value="'.strtolower($row['id']).'">'.$row['name'].'</option>';
                                            }
                                        }
                                    ?>
                                </select>
