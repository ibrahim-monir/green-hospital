        ...
        <div class="card">
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php
                            $loginPatientId = $_SESSION["patient_id"];
                            $loginPatientSql = "SELECT * FROM appointments WHERE patient_id = {$loginPatientId}";
                            $loginPatientQuery = mysqli_query( $conn, $loginPatientSql );
                            if ( 1 == $loginPatientQuery->num_rows){
                                $loginPatientData = mysqli_fetch_assoc( $loginPatientQuery );
                                $loginPatientDataId = $loginPatientData['id'];
                                $sql = "SELECT * FROM prescriptions WHERE appointments_id = {$loginPatientDataId}";
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo "No prescriptions found." ?></td>
                                    </tr>
                                <?php
                            }                            
                        ?>
