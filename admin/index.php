    ...
    <div class="row clearfix">
        <div class="col-12">
            <div class="section_title">
                <div class="mr-3">
                    <h3>Upcoming Operations List</h3>
                    <small>Statistics, Predictive Analytics Data Visualization, Big Data Analytics, etc.</small>
                </div>
                <div>
                    <div class="btn-group mb-3">
                        <div class="btn-group" role="group">
                            <button id="btnGroupDrop1" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">15 Aug 2020</button>
                        ...
                        <table class="table mb-0 table-borderless table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="media mb-0">
                                            <img src="assets/images/xs/avatar1.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="rounded-circle w35" data-original-title="Avatar Name">
                                    ...
                                    <td>15-08-2020</td>
                                    <td><a href="#"><i class="fa fa-file-pdf-o text-danger font-16"></i></a></td>
                                    <td>Fracture</td>
                                </tr>
                                <tr>
                                    <td>B-231</td>
                                    <td>
                                        <div class="media mb-0">
                                            <img src="assets/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="rounded-circle w35" data-original-title="Avatar Name">
                                            <div class="media-body ml-3">
                                    ...
                                    <td>
                                        <div class="avatar-list avatar-list-stacked">
                                            <img class="avatar avatar sm" src="assets/images/xs/avatar8.jpg" data-toggle="tooltip" title="" data-original-title="Avatar">
                                            <img class="avatar avatar sm" src="assets/images/xs/avatar1.jpg" data-toggle="tooltip" title="" data-original-title="Avatar">
                                        </div>
                                    </td>
                                    <td>15-08-2020</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media mb-0">
                                            <img src="assets/images/xs/avatar3.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="rounded-circle w35" data-original-title="Avatar Name">
                                            <div class="media-body ml-3">
                                    ...
                                    <td>
                                        <div class="avatar-list avatar-list-stacked">
                                            <img class="avatar avatar sm" src="assets/images/xs/avatar9.jpg" data-toggle="tooltip" title="" data-original-title="Avatar">
                                        </div>
                                    </td>
                                    <td>15-08-2020</td>
                                    <td><a href="#"><i class="fa fa-file-pdf-o text-danger font-16"></i></a></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media mb-0">
                                            <img src="assets/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="rounded-circle w35" data-original-title="Avatar Name">
                                            <div class="media-body ml-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media mb-0">
                                            <img src="assets/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="rounded-circle w35" data-original-title="Avatar Name">
                                            <div class="media-body ml-3">
