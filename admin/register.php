...
<head>
<title>Green Hospital | Sign Up</title>
<meta charset="utf-8">
    ...
    <div class="auth-main">
        <div class="auth_div vivify fadeIn">
            <div class="auth_brand">
                <a class="navbar-brand" href="/"><img src="assets/images/icon.svg" width="50" class="d-inline-block align-top mr-2" alt="">Green Hospital</a>                                                
            </div>
            <div class="card">
                <div class="header">
